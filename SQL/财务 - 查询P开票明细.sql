...
SELECT FIO.TITLE                                             AS '客户名称',
       ...
       FIOD.SM_ID,
       FIOD.MODEL_ID
FROM PFNC.FNC_INVOICE_OUT FIO
         INNER JOIN PFNC.FNC_INVOICE_OUT_DETAIL FIOD ON FIOD.INVOICE_OUT_ID = FIO.ID
         LEFT JOIN PODR.PODR_ORDER_MODEL OOM ON FIOD.ORDER_MODEL_ID = OOM.ID
...
WHERE FIO.STATUS IN (10, 20, 40)
  ...
  AND FIO.`CREATED_AT` < '2022-12-01 00:00:00'
