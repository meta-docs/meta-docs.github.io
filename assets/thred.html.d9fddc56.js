import{_ as i,V as n,W as e,a1 as l}from"./framework.46148295.js";const s={},d=l(`<h1 id="java多线程的用法详解" tabindex="-1"><a class="header-anchor" href="#java多线程的用法详解" aria-hidden="true">#</a> Java多线程的用法详解</h1><h2 id="_1-创建线程" tabindex="-1"><a class="header-anchor" href="#_1-创建线程" aria-hidden="true">#</a> 1.创建线程</h2><p>在Java中创建线程有两种方法：使用Thread类和使用Runnable接口。在使用Runnable接口时需要建立一个Thread实例。因此，无论是通过Thread类还是Runnable接口建立线程，都必须建立Thread类或它的子类的实例。Thread构造函数：</p><ul><li>public Thread( );</li><li>public Thread(Runnable target);</li><li>public Thread(String name);</li><li>public Thread(Runnable target, String name);</li><li>public Thread(ThreadGroup group, Runnable target);</li><li>public Thread(ThreadGroup group, String name);</li><li>public Thread(ThreadGroup group, Runnable target, String name);</li><li>public Thread(ThreadGroup group, Runnable target, String name, long stackSize);</li></ul><p><strong>方法一：继承Thread类覆盖run方法</strong></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>public class ThreadDemo1 {
